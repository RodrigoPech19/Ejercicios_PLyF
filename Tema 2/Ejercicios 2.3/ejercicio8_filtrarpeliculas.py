...
calificacio_mayor = list(filter(lambda pelicula: float(pelicula["CalificaciónIMDB"]) >= 8.0, lista_peliculas))

nueva_lista = list(map(lambda pelicula:{"titulo": pelicula["Titulo"], "calificacion": pelicula["CalificaciónIMDB"]}, calificacio_mayor))

print(calificacio_mayor)
print(nueva_lista)